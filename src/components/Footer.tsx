  ...
  return (
    <footer className="bg-brand-dark text-white pt-12 sm:pt-16 pb-8 px-4 sm:px-6 md:px-16">
      <div className="max-w-7xl mx-auto">
        <div className="flex flex-col md:flex-row justify-between items-center md:items-start text-center md:text-left gap-6 md:gap-8 mb-12 md:mb-16">
          <div>
          ...
          <div className="flex flex-wrap justify-center md:justify-start gap-x-4 sm:gap-x-6 gap-y-2 text-xs sm:text-sm font-medium tracking-wide text-white/80">
        ...
        <div className="max-w-7xl mx-auto border-t border-white/10 pt-6 sm:pt-8 flex flex-col sm:flex-row justify-between items-center text-[10px] sm:text-xs text-[#8c7f73] gap-2 sm:gap-0 text-center sm:text-left">
