...
export default function MaterialStory() {
  ...
  return (
    <section className="py-16 md:py-32 px-4 sm:px-6 md:px-12 bg-brand-bg text-[#f4f0ec]">
      <div className="max-w-6xl mx-auto">
        <div className="text-center mb-12 md:mb-24">
          ...
          <motion.p 
            ...
            className="text-2xl sm:text-3xl md:text-5xl font-serif px-2"
          >
            Natural meets Engineered.
          </motion.p>
        </div>

        <div className="grid md:grid-cols-2 gap-10 md:gap-8 lg:gap-24 items-center">
          <motion.div 
          ...
          >
            <h3 className="text-xl md:text-2xl font-serif text-[#cfa15f]">Jute</h3>
          ...
          <motion.div 
            ...
            className="space-y-4 md:space-y-6 md:text-right"
          >
            <h3 className="text-xl md:text-2xl font-serif text-[#8b5a2b]">Vegan Leather</h3>
            <p className="text-white/70 font-light leading-relaxed text-sm md:text-base">
        ...
        <motion.div 
          ...
          className="mt-12 md:mt-24 text-center max-w-3xl mx-auto p-6 md:p-12 border border-white/5 bg-[#1a1a1a] rounded-2xl shadow-2xl"
        >
          <p className="text-base md:text-2xl font-serif italic text-[#cfa15f] px-2">
